...
$('.select_prod_person').click(function(){
  var dataId = this.id;
  var idventa= $("#idproforma").val();
  var token = $("input[name=_token]").val();
  //var route = '/admin/saveprod/'; 
  var route = '{{ url("admin/saveprod") }}'; 
  var id = $(this).parents("tr").find("td")[1].innerHTML;
  var prod = $(this).parents("tr").find("td")[3].innerHTML;
  var codbarra = $(this).parents("tr").find("td")[5].innerHTML;
  var precio = $(this).parents("tr").find("td")[6].innerHTML;
  var stock = $(this).parents("tr").find("td")[7].innerHTML;
